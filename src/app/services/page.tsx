          ...
          <Tabs defaultValue="technology" className="w-full max-w-4xl mx-auto">
            ...
            <TabsContent value="technology" className="pt-6">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <Image src="https://i.postimg.cc/T1MPD6Lt/2150169850.jpg" alt="Laptop with code" width={800} height={600} className="rounded-lg shadow-lg" data-ai-hint="laptop code"/>
                <div>
            ...
            <TabsContent value="support" className="pt-6">
                 <div className="grid md:grid-cols-2 gap-8 items-center">
                    <Image src="https://i.postimg.cc/jqgNLWZ5/11710.jpg" alt="Support team" width={800} height={600} className="rounded-lg shadow-lg" data-ai-hint="customer support"/>
                    <div>
                        <p className="text-muted-foreground mb-4">
            ...
            <TabsContent value="quality" className="pt-6">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    <Image src="https://i.postimg.cc/C5XzJqQs/2149631023.jpg" alt="Quality check" width={800} height={600} className="rounded-lg shadow-lg" data-ai-hint="quality assurance"/>
                    <div>
                        <p className="text-muted-foreground mb-4">
